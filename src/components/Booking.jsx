      ...
      <div className="max-width mx-auto flex justify-between items-center rounded-2xl px-[133px] py-16 shadow-lg bg-white gap-10">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600">+88 (0172) 293-8124</p>
            <p className="text-gray-600">info@ladentista.net</p>
        ...
        <div className="flex items-start gap-4"> {/* Removed border-l */}
          ...
          <div>
            ...
            <p className="text-gray-600">Dental Implants</p>
            <p className="text-gray-600">Teeth Whitening</p>
          </div>
        </div>
      </div>
    </div>
